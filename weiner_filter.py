...
# Github link - https://github.com/tranleanh/Wiener-Filter-image-restoration/blob/master/Wiener_Filter.py
...
if __name__ == '__main__':
    ...
    file_name = os.path.join('deblur-2400.jpg')
    ...
    # cv2.imwrite('deblur-weiner.jpg', filtered_img)
    plt.imsave('deblur-weiner.png', filtered_img, cmap='gray')
    # Display results
